DROP DATABASE IF EXISTS ssb09; 
CREATE DATABASE ssb09; 
USE ssb09;
...
CREATE REFERENCE TABLE customer(
  ...
  KEY(C_Region) USING CLUSTERED COLUMNSTORE
);

CREATE REFERENCE TABLE dim_date(
...
CREATE REFERENCE TABLE supplier(
  ...
  KEY(S_Region) USING CLUSTERED COLUMNSTORE
);
